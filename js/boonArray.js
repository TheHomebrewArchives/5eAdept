var a1 = [
    ...
    },
    {
      ...
      "cost":3,
      "prereq":"<a onclick='boonDisplay(6)' href='#5'> Endurance </a>",
    ...
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(15)' href='#14'> Master Craftsman</a>, +9 or greater with a Craft skill",
    ...
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(21)' href='#20'> Soul Tether</a>, Character level 5th",
      "desc":"You gain one additional attunement slot. <br><br>You may take this boon only once.",
      "type":"General Boon",
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(22)' href='#21'> Improved Soul Tether</a>, Character level 11th",
      "desc":"You gain one additional attunement slot. <br><br>You may take this boon only once.",
      "type":"General Boon",
    },
    {
    ...
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(29)' href='#28'> Arcane Strike</a>, Character level 5th",
    ...
    },
    {
      ...
      "cost":3,
      "prereq":"<a onclick='boonDisplay(29)' href='#28'> Arcane Strike</a>, Character level 5th",
      "desc":"Your weapon attacks deal an additional 2 force damage, and are considered magical. <br><br>This boon replaces<a onclick='boonDisplay(29)' href='#28> Arcane Strike</a>.",
      "type":"Combat Boon",
    },
    {
      "name":"Battle-Ready",
    ...
    },
    {
      "name":"Cleave",
      "cost":3,
      "prereq":"<a onclick='boonDisplay(37)' href='#36'> Great Weapon Master</a>, Strength 15 or higher",
      "desc":"If you hit a creature with a heavy melee weapon that deals slashing damage using<a onclick='boonDisplay(37)' href='#36'> Great Weapon Master </a>on your turn, you can attack with that weapon again as apart of your attack action, against a different creature. You can make this additional attack only once per turn. <br><br>You cannot use<a onclick='boonDisplay(37)' href='#36'> Great Weapon Master </a>with this attack.",
      "type":"Combat Boon",
    },
    {
      "name":"Clobber",
      "cost":3,
      "prereq":"<a onclick='boonDisplay(37)' href='#36'> Great Weapon Master</a>, Strength 15 or higher",
      "desc":"If you hit a creature with a heavy melee weapon that deals bludgeoning damage using<a onclick='boonDisplay(37)' href='#36'> Great Weapon Master </a>on your turn, you can attack with that weapon again as apart of your attack action, against the same creature. You can make this additional attack only once per turn. <br><br>You cannot use<a onclick='boonDisplay(37)' href='#36'> Great Weapon Master </a>with this attack.",
      "type":"Combat Boon",
    },
    {
      "name":"Haft Strike",
    ...
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(41)' href='#40'> Improved Charge</a>, Strength 13 or higher",
    ...
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(43)' href='#42'> Improved Disarm </a>",
    ...
    },
    {
      "name":"Mobility",
      "cost":2,
      "prereq":"<a onclick='boonDisplay(45)' href='#44'> Improved Dodge </a>",
    ...
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(47)' href='#46'> Improved Grapple </a>",
    ...
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(47)' href='#46'> Improved Grapple</a>, Strength 15 or higher",
    ...
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(47)' href='#46'> Improved Grapple </a>",
      "desc":"You can use your action to try to pin a creature grappled by you. To do so, make another grapple maneuver check against the creature you are grappling. If you succeed, you and the creature are both restrained until the grapple ends.",
      "type":"Combat Boon",
    },
    {
      "name":"Improved Lunge",
    ...
    },
    {
      "name":"Advanced Lunge",
      "cost":2,
      "prereq":"<a onclick='boonDisplay(51)' href='#50'> Improved Lunge </a>",
    ...
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(53)' href='#52'> Improved Overrun </a>",
    ...
    },
    {
      "name":"Advanced Shove",
      "cost":2,
      "prereq":"<a onclick='boonDisplay(55)' href='#54'> Improved Shove </a>",
    ...
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(57)' href='#56'> Improved Sunder </a>",
    ...
    },
    {
      "name":"Advanced Trip",
      "cost":2,
      "prereq":"<a onclick='boonDisplay(59)' href='#58'> Improved Trip </a>",
    ...
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(61)' href='#60'> Improved Two Weapon Fighting </a>",
    ...
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(6)' href='#5'> Endurance</a>, Character level 5th",
      "desc":"When you are reduced to 0 hit points, you may make a DC 15 Constitution saving throw. On a success, you do not receive a level of exhaustion.",
      "type":"Combat Boon",
    },
    {
      "name":"Improved Warrior's Fervor",
      "cost":3,
      "prereq":"<a onclick='boonDisplay(71)' href='#70'> Warrior's Fervor </a> <a onclick='boonDisplay(7)' href='#6'> Improved Endurance </a>",
    ...
    // Critical Boons
    {
      ...
      "desc":"When you score a critical hit with a weapon attack, you can roll the damage dice for that attack one additional time. <br><br>You may only apply the effects of one Critical Boon to a given critical hit, unless you possess<a onclick='boonDisplay(74)' href='#73'> Critical Mastery</a>.",
      "type":"Critical Boon",
    },
    {
    ...
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(73)' href='#72'> Improved Critical</a>, Character level 8th",
      "desc":"When you score a critical hit with a weapon attack, the creature you hit cannot gain hit points until the end of your next turn. <br><br>You may only apply the effects of one Critical Boon to a given critical hit, unless you possess<a onclick='boonDisplay(74)' href='#73'> Critical Mastery</a>.",
      "type":"Critical Boon",
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(73)' href='#72'> Improved Critical</a>, Character level 8th",
      "desc":"When you score a critical hit with a weapon attack, the creature you hit must make a Constitution saving throw or become blinded until the start of your next turn. <br><br>You may only apply the effects of one Critical Boon to a given critical hit, unless you possess<a onclick='boonDisplay(74)' href='#73'> Critical Mastery</a>.",
      "type":"Critical Boon",
    },
    {
      "name":"Disarming Critical",
      "cost":2,
      "prereq":"<a onclick='boonDisplay(73)' href='#72'> Improved Critical </a>",
    ...
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(73)' href='#72'> Improved Critical</a>, Strength 13 or higher",
    ...
    },
    {
      ...
      "cost":3,
      "prereq":"<a onclick='boonDisplay(73)' href='#72'> Improved Critical</a>, Character level 12th",
      "desc":"When you score a critical hit with a weapon attack, the creature you hit must succeed on a Constitution saving throw. On a failed save, they become stunned until the beginning of your next turn.<br><br>You may only apply the effects of one Critical Boon to a given critical hit, unless you possess<a onclick='boonDisplay(74)' href='#73'> Critical Mastery</a>.",
      "type":"Critical Boon",
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(73)' href='#72'> Improved Critical </a>",
      "desc":"When you score a critical hit with a weapon attack, the creature you hit must make a Wisdom saving throw or become frightened by you until the end of their next turn.<br><br>You may only apply the effects of one Critical Boon to a given critical hit, unless you possess<a onclick='boonDisplay(74)' href='#73'> Critical Mastery</a>.",
      "type":"Critical Boon",
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(73)' href='#72'> Improved Critical </a>",
      "desc":"When you score a critical hit with a weapon attack, the creature you hit must make a Constitution saving throw, or gain one level of exhaustion.<br><br>You may only apply the effects of one Critical Boon to a given critical hit, unless you possess<a onclick='boonDisplay(74)' href='#73'> Critical Mastery</a>.",
      "type":"Critical Boon",
    },
    {
    ...
    },
    {
      "name":"Minor Magic",
      "cost":1,
      "prereq":"<a onclick='boonDisplay(84)' href='#83'> Basic Magic </a>",
    ...
    },
    {
      "name":"Major Magic",
      "cost":2,
      "prereq":"<a onclick='boonDisplay(85)' href='#84'> Minor Magic</a>, Character level 4th",
    ...
    },
    {
      "name":"Ultimate Magic",
      "cost":3,
      "prereq":"<a onclick='boonDisplay(86)' href='#85'> Major Magic</a>, Character level 6th",
    ...
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(88)' href='#87'> Elemental Adept</a>, Character level 5th",
      "desc":"When you gain this boon, choose one of the damage types you chose when you took<a onclick='boonDisplay(88)' href='#87'> Elemental Adept</a>.<br><br>Spells you cast ignore Immunity to damage of the chosen type.<br><br>Each time you select this boon, you must choose a different damage type, that you have already picked from <a onclick='boonDisplay(88)' href='#87'> Elemental Adept</a>.",
      "type":"Spellcasting Boon",
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(88)' href='#87'> Elemental Adept</a>, Character level 5th",
      "desc":"When you gain this boon, choose one of the damage types you chose when you took<a onclick='boonDisplay(88)' href='#87'> Elemental Adept</a>.<br><br>When you roll damage for a spell you cast that deals damage of that type, you can treat any 1 on a damage die as a 2.<br><br>Each time you select this boon, you must choose a different damage type, that you have already picked from <a onclick='boonDisplay(88)' href='#87'> Elemental Adept</a>.",
      "type":"Spellcasting Boon",
    },
    {
      "name":"Energy Adept",
    ...
    },
    {
      "name":"Energy Expert",
      "cost":2,
      "prereq":"<a onclick='boonDisplay(91)' href='#90'> Energy Adept</a>, Character level 11th",
      "desc":"When you gain this boon, choose one of the damage types you chose when you took<a onclick='boonDisplay(91)' href='#90'> Energy Adept</a>.<br><br>Spells you cast ignore Immunity to damage of the chosen type.<br><br>Each time you select this boon, you must choose a different damage type, that you have already picked from <a onclick='boonDisplay(91)' href='#90'> Energy Adept</a>.",
      "type":"Spellcasting Boon",
    },
    {
      "name":"Energy Potency",
      "cost":2,
      "prereq":"<a onclick='boonDisplay(91)' href='#90'> Energy Adept</a>, Character level 11th",
      "desc":"When you gain this boon, choose one of the damage types you chose when you took<a onclick='boonDisplay(91)' href='#90'> Energy Adept</a>.<br><br>When you roll damage for a spell you cast that deals damage of that type, you can treat any 1 on a damage die as a 2.<br><br>Each time you select this boon, you must choose a different damage type, that you have already picked from <a onclick='boonDisplay(91)' href='#90'> Energy Adept</a>.",
      "type":"Spellcasting Boon",
    },
    {
    ...
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(94)' href='#93'> Improved Concentration </a>",
    ...
    },
    {
      ...
      "cost":3,
      "prereq":"<a onclick='boonDisplay(94)' href='#93'> Improved Concentration</a>, Character level 7th",
    ...
    },
    {
      ...
      "cost":3,
      "prereq":"<a onclick='boonDisplay(94)' href='#93'> Improved Concentration</a>, Character level 5th",
    ...
    },
    {
      ...
      "cost":3,
      "prereq":"<a onclick='boonDisplay(99)' href='#98'> Improved Counterspell</a>, Character level 7th",
    ...
    },
    {
      ...
      "cost":2,
      "prereq":"2nd level spell slots",
      "desc":"When you cast a spell that has a duration of instantaneous, you can expend a 1st level spell to delay its effect. The spell does not trigger, instead triggering during any point on your next turn as a reaction, for this casting.<br><br>Alternatively, you can expend 1 sorcery point for the same effect.<br><br>You may only apply the effects of one Metamagic Boon to a given spell, unless you possess<a onclick='boonDisplay(119)' href='#118'> Metamagic Mastery</a>.",
      "type":"Metamagic Boon",
    },
    {
      "name":"Distant Spell",
    ...
    },
    {
      ...
      "cost":2,
      "prereq":"<a onclick='boonDisplay(104)' href='#103'> Distant Spell</a>, 3rd level spell slots",
      "desc":"When you use<a onclick='boonDisplay(104)' href='#103'> Distant Spell</a>, you triple the range instead of doubling it.<br><br>You may only apply the effects of one Metamagic Boon to a given spell, unless you possess<a onclick='boonDisplay(119)' href='#118'> Metamagic Mastery</a>.",
      "type":"Metamagic Boon",
    },
    {
    ...
    },
    {
      ...
      "cost":2,
      "prereq":"2nd level spell slots",
      "desc":"When you cast a spell that has a casting time of 1 action, you can expend a spell slot equal to one less than its slot level (minimum 1st level) to cast it as a bonus action, for that casting.<br><br>Alternatively, you can expend a number of sorcery points equal to the spell's slot level for the same effect.<br><br>You may only apply the effects of one Metamagic Boon to a given spell, unless you possess<a onclick='boonDisplay(119)' href='#118'> Metamagic Mastery</a>.",
      "type":"Metamagic Boon",
    },
    {
      "name":"Reaching Spell",
    ...
    },
    {
      ...
      "cost":2,
      "prereq":"2nd level spell slots",
      "desc":"When you cast a spell that targets only one creature and doesn't have a range of self, you can expend a spell slot equal to one less than its slot level (minimum 1st level) to target a second creature in range with the same spell, for that casting.<br><br>Alternatively, you can expend a number of sorcery points equal to the spell's slot level for the same effect.<br><br>You may only apply the effects of one Metamagic Boon to a given spell, unless you possess<a onclick='boonDisplay(119)' href='#118'> Metamagic Mastery</a>.",
      "type":"Metamagic Boon",
    },
    {
      "name":"Wide Spell",
    ...
    // Metamagic Mastery
    {
      ...
      "cost":3,
      "prereq":"At least two other Metamagic Boons, Character level 8th",
      "desc":"You may apply the effects of up to two Metamagic Boons on a single spell, as long as you pay the costs seperately.",
      "type":"Metamagic Boon",
    },
    //Prepare Maneuver
    {
      "name":"Improved Prepare",
      "cost":2,
      "prereq":"None",
      "desc":"When you perform a Prepare combat maneuver, you make the attack of opportunity at your normal attack bonus.",
      "type":"Combat Boon",
    },
    {
      "name":"Advanced Prepare",
      "cost":3,
      "prereq":"<a onclick='boonDisplay(120)' href='#119'> Improved Prepare </a>",
      "desc":"You can perform a Prepare combat maneuver in place of an attack when you take the attack action on your turn.",
      "type":"Combat Boon",
    },
    // Culture Boons
    {
...
//Link to a boon --> <a onclick='boonDisplay(x)' href='#x-1'> Boon Name </a>
